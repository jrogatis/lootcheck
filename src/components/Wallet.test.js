...
describe('Wallet', () => {
  ...
  it('creates a input to deposit into or witdraw from the balance', () => {
  ...
  describe('when the user types into the wallet input', () => {
    ...
    describe('and user wants to make a deposit', () => {
      ...
      it('dispatches the `deposit()` it receiver from props with local balance', () => {
    ...
    describe('and user wants to make a withdrawal', () => {
      ...
      it('dispatches the `withdraw()` it receiver from props with local balance', () => {
